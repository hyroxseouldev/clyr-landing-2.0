...
- On mobile, keep the header actions right-aligned within the same symmetric shell gutters as the text-only brand; do not leave unused flex space to the right of the menu button.
